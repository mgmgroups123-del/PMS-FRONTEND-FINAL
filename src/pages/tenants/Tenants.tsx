...
export default function Tenants() {
	...
	const stats = [
		...
		},
		{
			...
			value: data?.paidThisMonth?.length.toString() || '0',
			bgColor: 'bg-red-100',
		...
		},
		{
			...
			value: data?.pendingThisMonth?.length.toString() || '0',
								...
								<SelectContent className='bg-white'>
									{rowsPerPageOptions.map((option) => (
										<SelectItem
											...
											className={`hover:bg-[#ed3237] hover:text-white mb-0.5 ${
												pagination.rowsPerPage === option
